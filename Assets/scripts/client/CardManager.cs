...
public class CardManager
{
	...
	void TEST_MAKE_SHAKING_CARDS()
	{
		...
		this.cards.Add(new Card(3, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(10, PAE_TYPE.KWANG, 0));
		this.cards.Add(new Card(5, PAE_TYPE.PEE, 2));
		this.cards.Add(new Card(9, PAE_TYPE.PEE, 2));

		this.cards.Add(new Card(10, PAE_TYPE.PEE, 2));
		this.cards.Add(new Card(5, PAE_TYPE.YEOL, 0));
		this.cards.Add(new Card(4, PAE_TYPE.YEOL, 0));
		this.cards.Add(new Card(0, PAE_TYPE.PEE, 2));
		this.cards.Add(new Card(1, PAE_TYPE.PEE, 2));

		this.cards.Add(new Card(4, PAE_TYPE.PEE, 2));
		this.cards.Add(new Card(9, PAE_TYPE.TEE, 1));
		this.cards.Add(new Card(6, PAE_TYPE.TEE, 1));
		this.cards.Add(new Card(1, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(7, PAE_TYPE.PEE, 2));

		this.cards.Add(new Card(2, PAE_TYPE.PEE, 2));
		this.cards.Add(new Card(2, PAE_TYPE.TEE, 1));
		this.cards.Add(new Card(3, PAE_TYPE.YEOL, 0));
		this.cards.Add(new Card(2, PAE_TYPE.PEE, 3));

		this.cards.Add(new Card(6, PAE_TYPE.YEOL, 0));
		this.cards.Add(new Card(0, PAE_TYPE.TEE, 1));
		this.cards.Add(new Card(5, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(0, PAE_TYPE.KWANG, 0));
		this.cards.Add(new Card(8, PAE_TYPE.TEE, 1));

		this.cards.Add(new Card(1, PAE_TYPE.TEE, 1));
		this.cards.Add(new Card(7, PAE_TYPE.KWANG, 0));
		this.cards.Add(new Card(7, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(11, PAE_TYPE.KWANG, 0));
		this.cards.Add(new Card(10, PAE_TYPE.PEE, 3));

		this.cards.Add(new Card(4, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(5, PAE_TYPE.TEE, 1));
		this.cards.Add(new Card(0, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(11, PAE_TYPE.TEE, 2));
		this.cards.Add(new Card(8, PAE_TYPE.PEE, 2));
		this.cards.Add(new Card(11, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(2, PAE_TYPE.KWANG, 0));
		this.cards.Add(new Card(6, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(3, PAE_TYPE.PEE, 2));
		this.cards.Add(new Card(9, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(1, PAE_TYPE.YEOL, 0));
		this.cards.Add(new Card(4, PAE_TYPE.TEE, 1));
		this.cards.Add(new Card(3, PAE_TYPE.TEE, 1));
		this.cards.Add(new Card(8, PAE_TYPE.PEE, 3));
		this.cards.Add(new Card(6, PAE_TYPE.PEE, 2));
		this.cards.Add(new Card(11, PAE_TYPE.YEOL, 1));
		this.cards.Add(new Card(8, PAE_TYPE.YEOL, 0));
		this.cards.Add(new Card(9, PAE_TYPE.YEOL, 0));
		this.cards.Add(new Card(10, PAE_TYPE.PEE, 1));
		this.cards.Add(new Card(7, PAE_TYPE.YEOL, 1));
	}
