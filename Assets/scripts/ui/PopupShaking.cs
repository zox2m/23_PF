...
public class PopupShaking : MonoBehaviour {

	Card selected_card_info;
	byte card_slot;
	...
	public void refresh(Card selected_card_info, byte card_slot)
	{
	...
	void on_choice_shaking(byte is_shaking)
	{
		...
		PlayRoomUI.send_select_card(this.selected_card_info, this.card_slot, is_shaking);
	}
}
